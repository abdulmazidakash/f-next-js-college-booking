  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] bg-gray-100">
      <div className="w-full max-w-md p-8 bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-lg shadow-md border border-gray-200">
        <h2 className="text-2xl font-bold text-center bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 bg-clip-text text-transparent mb-6">Forgot Password</h2>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link href="/login" className="text-button-bg hover:underline">
            Login here
          </Link>
        </p>
      </div>
